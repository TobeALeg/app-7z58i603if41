...
- 🔐 **学校统一身份认证** - 集成OAuth 2.0 SSO，无需注册
- 📝 **在线报名** - 便捷的报名表单，支持团队参赛
- 📤 **作品提交** - 支持文件上传，自动图片压缩
- 📊 **报名管理** - 实时查看报名状态和审核结果
- 👨‍💼 **管理后台** - 报名审核、用户管理
- 🎨 **现代设计** - 科技蓝+清新绿配色，响应式布局

### 🔑 OAuth 2.0 SSO 登录

本系统已集成学校统一身份认证，用户使用学号密码登录，无需单独注册。

**快速配置**: 查看 [QUICK_START.md](./QUICK_START.md)

**详细文档**: 查看 [OAUTH_SETUP.md](./OAUTH_SETUP.md)
